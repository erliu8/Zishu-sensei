...
import { FavoritePostCard } from '@/features/social/components';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function FavoritePostsPage() {
  ...
  React.useEffect(() => {
    if (!isAuthenticated) {
      router.push('/login?redirect=/profile/favorites/posts');
    }
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">收藏的帖子</h1>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {removeTarget && removeTarget.ids.length > 1 ? (
                <>
                  确定要从收藏中移除这 <span className="font-semibold">{removeTarget.ids.length}</span> 个帖子吗？
                  此操作无法撤销。
                </>
              ) : (
                <>
