...
export default function ProfileSettingsPage() {
  const { user, isLoading: userLoading } = useCurrentUser() as { user: UserProfile | null; isLoading: boolean; };
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      location: (user as UserProfile)?.location || '',
      website: (user as UserProfile)?.website || '',
      github: (user as UserProfile)?.github || '',
      twitter: (user as UserProfile)?.twitter || '',
    },
    values: {
      name: (user as UserProfile)?.name || '',
      bio: (user as UserProfile)?.bio || '',
