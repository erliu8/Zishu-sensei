...
import type { UpdatePostDto, CreatePostInput, UpdatePostInput } from '@/features/post/domain';
import {
  Button,
  Alert,
  AlertDescription,
...
export default function EditPostPage() {
  ...
  const handleSave = async (data: CreatePostInput | UpdatePostInput) => {
    try {
      // 确保数据包含id
      const updateData = { ...data, id: postId } as UpdatePostInput;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* 编辑器 */}
        <PostEditor
          initialData={{ ...formData, id: postId } as UpdatePostInput}
          onSave={handleSave}
