...
import { AdapterCard, AdapterList } from '@/features/adapter/components/marketplace';
import { FeaturedAdapters } from '@/features/adapter/components/marketplace/FeaturedAdapters';
import { CategoryFilter } from '@/features/adapter/components/marketplace/CategoryFilter';
import { SortOptions } from '@/features/adapter/components/marketplace/SortOptions';
import {
  Sheet,
  SheetContent,
  SheetDescription,
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">适配器市场</h1>
            <p className="text-muted-foreground">
              发现和下载优质适配器，扩展你的 AI 助手能力
            </p>
          </div>
