...
import { useCharacters } from '@/features/character/hooks/use-characters';
    ...
    <div className={cn('space-y-4', className)}>
      <div className="flex items-center justify-between">
        ...
        <Link href="/characters">
          <Button variant="ghost">探索更多</Button>
        </Link>
      </div>
                ...
                <CardContent className="pt-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Avatar className="h-6 w-6">
                      <AvatarImage src={character.creator?.avatar} alt={character.creator?.name} />
                      <AvatarFallback>{character.creator?.name?.[0]}</AvatarFallback>
                    </Avatar>
                ...
                <CardFooter className="flex items-center justify-between pt-4 border-t">
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{character.stats?.usageCount?.toLocaleString() || 0}</span>
                    </div>
                  </div>
