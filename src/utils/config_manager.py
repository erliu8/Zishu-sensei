...
class ConfigManager:
    ...
    def register_callback(self,config_name:str,callback:Callable[[str,Dict[str,Any]],None]):
        """注册配置变化回调函数"""
    ...
    def _watch_config_files(self,interval:int):
        ...
        while not self.stop_event.is_set():
            for config_name in list(self.configs.keys()):
                ...
                if config_name in self.last_modified_times and mod_time > self.last_modified_times[config_name]:
