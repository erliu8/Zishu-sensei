...
from zishu.utils.attention_utils import (
    check_sdpa_support,
    configure_sdpa_for_model,
    ...
    def load_model(self):
        ...
        try:
            ...
            self._model = AutoModelForCausalLM.from_pretrained(
                model_path, config=model_config, trust_remote_code=True, **model_kwargs
            )
            # 如果启用了高效注意力，配置SDPA
            if efficient_attn_enabled and sdpa_info and sdpa_info["sdpa_available"]:
