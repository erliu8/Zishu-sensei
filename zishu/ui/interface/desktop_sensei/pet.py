...
class Zishusensei(QMainWindow):
    ...
    def __init__(self,config_path="./config/desktop_config.json",character_path="./config/character/default.json"):
        super().__init__()
        ...
        #加载HTML文件以渲染Live2D模型
        self.web_view.load(QUrl.fromLocalFile(os.path.abspath("./assets/live2d_renderer/live2d_renderer.html")))
    ...
    def update_animation(self):
        ...
        if self.current_state == "idle":
            ...
            if random.random() < 0.01: #1%概率切换动画
                idle_action = random.choice(self.character["appearance"]["behavior"]["idle_animations"])
    ...
    def contextMenuEvent(self,event):
        ...
        if self.config["interaction"]["context_menu"]:
            ...
            for accessory in self.character["appearance"]["accessories"]:
                ...
                action.triggered.connect(lambda checked,a=accessory:self.change_accessory(a))
