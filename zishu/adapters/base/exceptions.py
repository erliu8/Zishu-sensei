...
class AdapterInputValidationError(BaseAdapterException):
    """适配器输入验证错误"""
    def __init__(self, message: str, input_errors: Optional[Dict[str, Any]] = None, **kwargs):
        context = kwargs.get('context', {})
        if input_errors:
...
class AdapterOutputValidationError(BaseAdapterException):
    """适配器输出验证错误"""
    def __init__(self, message: str, output_errors: Optional[Dict[str, Any]] = None, **kwargs):
        context = kwargs.get('context', {})
        if output_errors:
...
class RAGEngineError(SoftAdapterError):
    ...
    def __init__(self, message: str, query: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.RAG_ENGINE_ERROR,
            **kwargs
        )
...
class KnowledgeBaseError(SoftAdapterError):
    ...
    def __init__(self, message: str, kb_name: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.KNOWLEDGE_BASE_ERROR,
            **kwargs
        )
...
class RetrievalFailedError(SoftAdapterError):
    """检索失败错误"""
    def __init__(self, message: str, query: Optional[str] = None, retrieval_type: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if query:
            context['query'] = query
        if retrieval_type:
...
class HardAdapterError(BaseAdapterException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message,
            severity=ExceptionSeverity.HIGH,  # 硬适配器错误通常比较严重
            **kwargs
        )
...
class SystemOperationError(HardAdapterError):
    ...
    def __init__(self, message: str, operation: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.SYSTEM_OPERATION_FAILED,
            **kwargs
        )
...
class DesktopControlError(HardAdapterError):
    ...
    def __init__(self, message: str, control_type: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.DESKTOP_CONTROL_FAILED,
            **kwargs
        )
...
class PermissionDeniedError(HardAdapterError):
    """权限拒绝错误"""
    def __init__(self, message: str, required_permission: Optional[str] = None, resource: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
...
class IntelligentAdapterError(BaseAdapterException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message,
            severity=ExceptionSeverity.HIGH,  # 智能适配器错误通常比较严重
            **kwargs
        )
...
class CodeGenerationError(IntelligentAdapterError):
    """代码生成错误"""
    def __init__(self, message: str, prompt: Optional[str] = None, language: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if prompt:
        ...
        super().__init__(
            message,
            error_code=ErrorCode.CODE_GENERATION_FAILED,
            **kwargs
        )
...
class CodeExecutionError(IntelligentAdapterError):
    """代码执行错误"""
    def __init__(self, message: str, code: Optional[str] = None, execution_env: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if code:
        ...
        super().__init__(
            message,
            error_code=ErrorCode.CODE_EXECUTION_FAILED,
            **kwargs
        )
...
class ModelLoadingError(IntelligentAdapterError):
    """模型加载错误"""
    def __init__(self, message: str, model_path: Optional[str] = None, model_type: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if model_path:
...
class LearningEngineError(IntelligentAdapterError):
    ...
    def __init__(self, message: str, learning_task: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.LEARNING_ENGINE_ERROR,
            **kwargs
        )
...
class SecurityError(BaseAdapterException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message,
            severity=ExceptionSeverity.CRITICAL,  # 安全错误都是严重的
            **kwargs
        )
...
class SandboxBreachError(SecurityError):
    ...
    def __init__(self, message: str, attempted_action: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message,
            error_code=ErrorCode.SANDBOX_BREACH,
            **kwargs
        )
...
class UnauthorizedAccessError(SecurityError):
    """未授权访问错误"""
    def __init__(self, message: str, resource: Optional[str] = None, user_id: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if resource:
            context['resource'] = resource
        if user_id:
...
class MemoryLimitExceededError(ResourceError):
    """内存限制超出错误"""
    def __init__(self, message: str, current_memory: Optional[float] = None, limit_memory: Optional[float] = None, **kwargs):
        context = kwargs.get('context', {})
...
class CPULimitExceededError(ResourceError):
    """CPU限制超出错误"""
    def __init__(self, message: str, current_cpu: Optional[float] = None, limit_cpu: Optional[float] = None, **kwargs):
        context = kwargs.get('context', {})
        ...
        super().__init__(
            message,
            error_code=ErrorCode.CPU_LIMIT_EXCEEDED,
            **kwargs
        )
...
class AdapterCompositionError(BaseAdapterException):
    """适配器组合错误"""
    def __init__(self, message: str, composition_name: Optional[str] = None, failed_adapter: Optional[str] = None, **kwargs):
        context = kwargs.get('context', {})
        if composition_name:
