...
from .interfaces import (
    IStorageBackend, IAdapterStorage, StorageBackendType,
    StorageException, NotFoundError
)
...
class StorageManager:
    ...
    async def _initialize_backend(self, name: str, config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self._logger.info(f"Backend '{name}' ({backend_type_str}) initialized successfully")
            return True
    ...
    def get_adapter_storage(self, backend_name: Optional[str] = None) -> Optional[IAdapterStorage]:
        """获取适配器存储"""
    ...
    async def create_backend(self, name: str, backend_type: StorageBackendType, 
    ...
    async def migrate_data(self, source_backend: str, target_backend: str,
    ...
    async def backup_data(self, backend_name: Optional[str] = None,
        ...
        try:
            ...
            for collection in collections:
                try:
                    ...
                    self._logger.warning(f"Failed to backup collection '{collection}': {e}")
            ...
            return {
                ...
                'total_records': sum(len(records) for records in backup_data['collections'].values())
            }
                    ...
                    if overwrite:
                        ...
                        try:
                            ...
                            if existing_result.success and existing_result.data:
                                ...
                                if keys_to_delete:
                                    await backend.batch_delete(collection, keys_to_delete)
                        except Exception:
                            pass  # 忽略清空错误
