...
class IStorageEventListener(ABC):
    ...
    @abstractmethod
    async def on_before_operation(self, operation: StorageOperationType, 
                                 collection: str, data: Any) -> bool:
        """操作前事件"""
        pass
    
    @abstractmethod
    async def on_after_operation(self, operation: StorageOperationType,
                                collection: str, result: StorageResult) -> None:
        """操作后事件"""
        pass
    
    @abstractmethod
    async def on_error(self, operation: StorageOperationType,
                      collection: str, error: Exception) -> None:
        """错误事件"""
        pass
...
class IStorageMiddleware(ABC):
    ...
    @abstractmethod
    async def process_request(self, operation: StorageOperationType,
                             collection: str, data: Any) -> Any:
        """处理请求"""
        pass
    
    @abstractmethod
    async def process_response(self, operation: StorageOperationType,
                              collection: str, result: StorageResult) -> StorageResult:
        """处理响应"""
        pass
...
class StorageException(Exception):
    ...
    def __init__(self, message: str, operation: Optional[StorageOperationType] = None,
