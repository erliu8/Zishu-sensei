...
class FileSystemAdapter(BaseAdapter):
    ...
    async def read_file(
        ...
        try:
            ...
            async with aiofiles.open(full_path, mode, encoding=None if binary_mode else encoding) as f:
    ...
    async def write_file(
        ...
        try:
            ...
            # 写入文件
            mode = 'ab' if append_mode and isinstance(content, bytes) else 'a' if append_mode else 'wb' if isinstance(content, bytes) else 'w'
