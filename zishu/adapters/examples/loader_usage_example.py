...
from zishu.adapters.base.loader import (
    AdapterLoader, LoaderConfig, LoadRequest, LoadSource,
    SecurityLevel, CachePolicy,
...
async def error_handling_example():
    ...
    # 尝试从无效URL加载
    try:
        result = await load_adapter_from_url("http://invalid-url-that-does-not-exist.com/adapter.py")
        if not result.success:
