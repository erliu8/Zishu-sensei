...
class SampleAdapter(BaseAdapter):
        ...
        return AdapterMetadata(
            ...
            configuration_schema={
                ...
                "properties": {
                    ...
                    "add_prefix": {"type": "string", "default": ""},
                },
            },
        )
    ...
    async def _initialize_impl(self) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Sample adapter initialized with case_transform={self.case_transform}"
            )
            return True
    ...
    def _get_capabilities_impl(self) -> List[AdapterCapability]:
        ...
        return [
            ...
            AdapterCapability(
                ...
                category="text_processing",
                parameters={
                    "prefix": {"type": "string", "description": "Prefix to add to text"}
                },
            ),
        ]
...
async def main():
    ...
    try:
        ...
        async with adapter:
            ...
            # 处理一些文本
            test_inputs = ["hello world", "this is a test", "sample adapter demo"]
