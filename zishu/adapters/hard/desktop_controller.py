    ...
    def drag(
        ...
        try:
            ...
            if not (
                ...
                and self._validate_coordinates(end_x, end_y)
            ):
...
class WindowManager:
    ...
    def find_windows(
        self, title_pattern: str = None, class_name: str = None
    ) -> List[WindowInfo]:
        """查找匹配条件的窗口"""
        windows = []
        try:
    ...
    def activate_window(self, window: WindowInfo) -> bool:
        ...
        try:
            if platform.system() == "Linux" and window.handle:
                subprocess.run(
                    ["wmctrl", "-i", "-a", hex(window.handle)], timeout=5, check=False
                )
...
class ScreenController:
    ...
    def take_screenshot(
        self, region: Optional[Rectangle] = None
    ...
    def save_screenshot(
        self, filepath: str, region: Optional[Rectangle] = None
    ) -> bool:
        """保存截图到文件"""
        try:
...
class DesktopController(BaseAdapter):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self._max_operations_per_minute = (
            config.get("max_operations_per_minute", 1000) if config else 1000
        )
    ...
    def _check_rate_limit(self) -> bool:
        ...
        while (
            ...
            and current_time - self._operation_timestamps[0] > 60
        ):
    ...
    def click(self, x: int, y: int, button: str = "left", clicks: int = 1) -> bool:
        ...
        try:
            ...
            self._record_operation(
                "mouse_click", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def scroll(self, x: int, y: int, clicks: int) -> bool:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "mouse_scroll", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def press_key(self, key: str, duration: float = 0.0) -> bool:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "keyboard_press", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def press_keys(self, *keys: str) -> bool:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "keyboard_combination", parameters, result, duration_ms
            )
            return result
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "keyboard_combination", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def type_text(self, text: str, interval: float = 0.0) -> bool:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "keyboard_type", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def find_windows(self, title_pattern: str = None) -> List[WindowInfo]:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "window_find", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def activate_window(self, window: WindowInfo) -> bool:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "window_activate", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def take_screenshot(
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "screen_capture", parameters, result is not None, duration_ms
            )
            return result
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "screen_capture", parameters, False, duration_ms, str(e)
            )
            raise
    ...
    def find_image(
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "image_find", parameters, result is not None, duration_ms
            )
            return result
    ...
    def get_pixel_color(self, x: int, y: int) -> Tuple[int, int, int]:
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self._record_operation(
                "pixel_color", parameters, False, duration_ms, str(e)
            )
            raise
