...
class JWTManager:
    ...
    def create_refresh_token(
        self, user_id: str, session_id: str, expires_delta: Optional[timedelta] = None
    ) -> Dict[str, Any]:
        """创建刷新令牌"""
        if expires_delta is None:
    ...
    def create_verification_token(
        self, user_id: str, verification_type: str, target: str
    ) -> Dict[str, Any]:
        """创建验证令牌"""
...
class TokenPair:
    ...
    def __init__(
        self, access_token_data: Dict[str, Any], refresh_token_data: Dict[str, Any]
    ):
...
def create_token_pair(
    ...
    refresh_token_data = jwt_manager.create_refresh_token(
        user_id=user_id, session_id=session_id, expires_delta=refresh_expires_delta
    )
